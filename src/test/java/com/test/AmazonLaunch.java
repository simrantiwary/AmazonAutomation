...
public class AmazonLaunch {	
	...
	public void test1() throws InterruptedException
	{
		...
		ArrayList<WebElement> suggestedElements = new ArrayList<>(driver.findElements(By.className("s-suggestion-container")));
		...
		List<WebElement> SearchedResultELements = new ArrayList<>(driver.findElements(By.className("s-title-instructions-style")));
